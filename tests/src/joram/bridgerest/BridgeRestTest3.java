...
/**
 * Test: Test the behavior of BridgeDistributionQueue during stop / restart of Foreign server.
 */
public class BridgeRestTest3 extends TestCase implements MessageListener {
  public static void main(String[] args) {
    new BridgeRestTest3().run();
  }
  ...
  public void test() throws Exception {
    ...
    foreignCons = foreignSess.createConsumer(foreignQueue);
    foreignCons.setMessageListener(this);
    foreignCnx.start();
