 ...
 *  - Sends 10 messages through a JMS DistributionQueue.
 *  - Stops the foreign server.
 *  - Sends 10 more messages through a JMS DistributionQueue.
 *  - Restarts the foreign server.
 *  - Receives the sent messages on foreign queue.
 */
public class BridgeTest22x extends TestCase {
  public static void main(String[] args) {
    new BridgeTest22x().run();
  }
