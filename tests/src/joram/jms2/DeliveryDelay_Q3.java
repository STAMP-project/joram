...
/**
 * Test the delivery delay: Verify that a delayed message is scheduled after restart.
 */
public class DeliveryDelay_Q3 extends TestCase {

  public static void main(String[] args) {
    new DeliveryDelay_Q3().run();
  }
  ...
  void test() throws Exception {
    ...
    System.out.println("Message received: " + msg + " -> " + (recv - send));
    assertTrue("Don't receive scheduled message", (msg != null));
    assertTrue("The message is received before the delivery delay", ((recv - send) > 30000L));
