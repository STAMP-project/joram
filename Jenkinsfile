...
//      when { changeset "joram/joram/mom/core/src/test/**" }
      steps {
        withMaven(maven: 'maven3', jdk: 'JDK8') {
          sh '''cd joram
          mvn eu.stamp-project:dspot-maven:amplify-unit-tests -e -Dtest=org.objectweb.joram.mom.messages.MessageEncodingTest -Dtest=org.objectweb.joram.mom.notifications.TopicForwardNotTest'''
      }
